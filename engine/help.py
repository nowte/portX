__command__ = "help"
__description__ = "Tüm komutları listeler."
...
def get_parser_help(mod):
    ...
    return "Parametre bilgisi yok."

def main():
    log("Kullanılabilir Komutlar:", "info")
    ...
    for file in files:
        ...
        try:
            ...
            desc = getattr(mod, "__description__", "Açıklama bulunamadı.")
            print(f"\n  {cmd:<15} :: {desc}\n")
